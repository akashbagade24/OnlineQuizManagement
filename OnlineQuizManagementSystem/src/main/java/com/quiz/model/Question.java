...
public Question(int questionNo, Categories categeory, String questionTitle, String option1, String option2,
...
public Categories getCategeory() {
return categeory;
}



public void setCategeory(Categories categeory) {
this.categeory = categeory;
}
...
return "Question [questionNo=" + questionNo + ", categeory=" + categeory + ", questionTitle=" + questionTitle
